...
<div id="countryList" style="background-color:yellow"></div>	
    ...
    <section class="dorne-features-destinations-area">
        <div class="container-fluid">
            ...
            <h5><strong>Foods and Vegetables</strong></h5>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
					 ...
					 <?php
					 $result=select("select * from items where category='FruitVegetables' AND in_stock > '3' ORDER BY added_on DESC");
            ...
            <h5><strong>Foodgrains, Oil & Masala</strong></h5>
			<div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                     
					 <?php
					 $result=select("select * from items where category='FoodgrainsoilMasala' AND in_stock > '3' ORDER BY added_on DESC");
					 while($r=mysqli_fetch_array($result))
					 {
						 extract($r);
					 ?>
            ...
            <h5><strong>Bakery, Cakes & Dairy</strong></h5>
			<div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                     
					 <?php
					 $result=select("select * from items where category='BakerycakesDairy' AND in_stock > '3' ORDER BY added_on DESC");
					 while($r=mysqli_fetch_array($result))
					 {
						 extract($r);
					 ?>
            ...
            <h5><strong>Snacks & Branded Foods</strong></h5>
			...
			<div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
					 ...
					 <?php
					 $result=select("select * from items where category='SnacksBrandedFoods' AND in_stock > '3' ORDER BY added_on DESC");
					 while($r=mysqli_fetch_array($result))
					 {
						 extract($r);
					 ?>
			...
			<div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
					 ...
					 <?php
					 $result=select("select * from items where category='Beverage' AND in_stock > '3' ORDER BY added_on DESC");
					 while($r=mysqli_fetch_array($result))
					 {
						 extract($r);
					 ?>
            ...
            <h5><strong>Cleaning & Household</strong></h5>
			<div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                     
					 <?php
					 $result=select("select * from items where category='Cleaninghousehold' AND in_stock > '3' ORDER BY added_on DESC");
					 while($r=mysqli_fetch_array($result))
					 {
						 extract($r);
					 ?>
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Project is made by MEN</a>
