...
// Automatically deleting out of stock items from cart
$delete_sql = "DELETE FROM cart WHERE userid='".$_SESSION['userid']."' AND itemid IN (SELECT itemid FROM items WHERE in_stock <= 3)";
$delete_query = select($delete_sql);
...
Remove
  ...
  ?>
     <a href="index.php" class="btn btn-danger" style="font-weight:bold">Total Price- <?=$t[0]?>  /-</a>
         ...
         {
            echo '<a href="#"><span class="btn btn-success"><strike>CheckOut</strike></span></a>';
         } else {
            echo '<a href="payment1.php"><span class="btn btn-success">CheckOut</span></a>';
         }
  }
	 ?>
  </div>
