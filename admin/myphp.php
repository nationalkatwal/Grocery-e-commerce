...
$tmp_name=$_FILES["image"]["tmp_name"];
	...
	echo $query="INSERT INTO  `items`( `Title`, `category`, `item_rating`, `image`, `discription`, `price`, `in_stock`)
	VALUES ('$title','$category','$rating','$name','$discription','$price','$stock')";
...
// $tmp_name=$_FILES["image"]["tmp_name"];
	...
	extract($_REQUEST);
	echo $query="UPDATE `items` SET `Title`='$title', `category`='$category', `item_rating`='$rating',  `discription`='$discription', `price`='$price', `in_stock`='$stock' WHERE itemid='$itemid'";
	// move_uploaded_file($tmp_name,"images/$name");
